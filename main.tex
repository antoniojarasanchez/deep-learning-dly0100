...
\renewcommand{\thedefinicion}{\thesection.\arabic{definicion}}

\newcounter{algoritmo}[section]
\renewcommand{\thealgoritmo}{\thesection.\arabic{algoritmo}}

\newcounter{advertencia}[section]
\renewcommand{\theadvertencia}{\thesection.\arabic{advertencia}}
...
Esta es la primera revisión (\textbf{Versión del \today}). Cualquier sugerencia, corrección, observación, etc. puede ser indicado al correo antoniojarasanchez@proton.me
...
\input{chapters/cap01-introduccion.tex}
